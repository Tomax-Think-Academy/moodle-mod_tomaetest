...
/**
 * The main mod_tomaetest configuration form.
 *
 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_tomaetest_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('tomaetestname', 'mod_tomaetest'), array('size' => '64'));
